-- https://github.com/tucows/kong-plugin-jwt-claims-advanced
...
return {
    ...
    fields = {{
        ...
        config = {
            type = "record",
            fields = { -- These 3 params 100% match the JWT plugin for how
            ...
            }, -- These params are the new ones for this plugin...
            {
                ...
                claims = {
                    ...
                    elements = {
                        ...
                        entity_checks = {{
                            at_least_one_of = {"output_header", "contains", "does_not_contain", "contains_one_of",
                                               "contains_none_of", "equals", "does_not_equal", "equals_one_of",
                                               "equals_none_of"}
                        }}
                    }
                }
